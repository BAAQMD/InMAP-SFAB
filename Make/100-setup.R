...
CA_ISRM_CELL_COUNT <- 21705
CA_ISRM_NC_URL <- "https://drive.google.com/u/0/uc?id=1v__TPKJeiL8Q4zLz8Dyx5HcWSqR2NDx4&export=download&confirm=t"
CA_ISRM_NC_PATH <- here::here("Data", "UW", "2022-04-25", "ca_isrm.ncf")
